...
function normalizeProductPayload(payload: ProductFormValues) {
  return {
    ...
    grade_details: null,
    base_price_ngn: payload.base_price_ngn,
    compare_at_price_ngn: payload.compare_at_price_ngn,
    cost_price_ngn: payload.cost_price_ngn,
  ...
  await supabase
    ...
    .upsert(
      variants.map((variant) => ({
        ...
        sku: variant.sku,
        price_override_ngn: variant.price_override_ngn,
